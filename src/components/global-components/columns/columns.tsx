...
const Columns = (props: Props) => {
  ...
  const columnsClass = cx('columns', props.className)

  const columnClass = cx('column', props.columnClassName)

  const COLUMNS = props.columns.map((column, i) => (
    <li className={columnClass} key={i}>
      <div
      ...
      >
        <div className={styles.columnContentWrapper}>
          <p className={styles.header}>{column.title}</p>
          {column.component}
        </div>
      </div>
    </li>
