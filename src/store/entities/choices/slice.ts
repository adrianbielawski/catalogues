...
// Types
import { type Choice, type DeserializedChoice } from 'src/globalTypes'
import { type FieldChoiceUpdated } from './types'
// Serializers
...
export const choicesEntitiesSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(CLEAR_APP_STATE, () => choicesAdapter.getInitialState())
  },
})

export const { CHOICES_UPDATED, CHOICE_UPDATED, CHOICE_ADDED, CHOICE_REMOVED } =
