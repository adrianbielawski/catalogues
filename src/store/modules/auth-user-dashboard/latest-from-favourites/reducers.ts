...
export const fetchLFFItemsComments = {
  ...
  FETCH_LFF_ITEMS_COMMENTS_SUCCESS(
    state: State,
    action: PayloadAction<T.FetchLFFItemsCommentsSuccessPayload>,
  ) {
...
export const fetchLFFItemComments = {
  FETCH_LFF_ITEM_COMMENTS(
    state: State,
    action: PayloadAction<T.FetchLFFItemCommentsPayload>,
  ) {},
  ...
  FETCH_LFF_ITEM_COMMENTS_SUCCESS(
    state: State,
    action: PayloadAction<T.FetchLFFItemCommentsSuccessPayload>,
  ) {
...
export const postLFFItemComment = {
  POST_LFF_ITEM_COMMENT(
    state: State,
    action: PayloadAction<T.PostLFFItemCommentPayload>,
  ) {},
  POST_LFF_ITEM_COMMENT_START(state: State, action: PayloadAction<number>) {
    const itemData = getItemDataById(state, action.payload)!
    itemData.isPostingComment = true
  },
  POST_LFF_ITEM_COMMENT_SUCCESS(
    state: State,
    action: PayloadAction<T.PostLFFItemCommentSuccessPayload>,
  ) {
