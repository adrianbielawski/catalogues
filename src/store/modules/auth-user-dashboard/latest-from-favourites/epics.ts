...
export const fetchLatestFromFavouritesEpic = (action$: Observable<Action>) =>
  action$.pipe(
...
export const fetchLFFItemsCommentsEpic = (action$: Observable<Action>) =>
  action$.pipe(
    filter(actions.FETCH_LFF_SUCCESS.match),
    mergeMap((action) => {
...
export const fetchLFFChoicesEpic = (action$: Observable<Action>) =>
  action$.pipe(
...
export const postLFFItemCommentEpic = (action$: Observable<Action>) =>
  action$.pipe(
        ...
        defer(() =>
          axiosInstance$
            ...
            .pipe(
              ...
              catchError(() =>
                of(
                  actions.POST_LFF_ITEM_COMMENT_FAILURE(action.payload.itemId),
                ),
              ),
            ),
        ),
          ...
          .pipe(
            mergeMap((response) =>
              concat(
                ...
                of(
                  actions.FETCH_LFF_ITEM_COMMENTS_SUCCESS({
            ...
            catchError(() =>
              of(
                actions.FETCH_LFF_ITEM_COMMENTS_FAILURE(action.payload.itemId),
              ),
            ),
          ),
      ),
...
export const latestFromFavouritesEpics = typedCombineEpics(
