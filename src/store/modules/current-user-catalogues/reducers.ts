...
export const fetchCurrentUserCataloguesReducers = {
    ...
    FETCH_CURRENT_USER_CATALOGUES_SUCCESS(state: State, action: PayloadAction<Catalogue[]>) {
...
export const fetchCurrentUserCatalogueFieldsReducers = {
    FETCH_CURRENT_USER_CATALOGUE_FIELDS(state: State, action: PayloadAction<number>) { },
    FETCH_CURRENT_USER_CATALOGUE_FIELDS_START(state: State, action: PayloadAction<number>) {
        const catalogue = getCatalogueDataById(state, action.payload)
        catalogue.isFetchingFields = true
    },
    FETCH_CURRENT_USER_CATALOGUE_FIELDS_SUCCESS(state: State, action: PayloadAction<T.FetchCatalogueFieldsSuccessPayload>) {
    ...
    FETCH_CURRENT_USER_CATALOGUE_FIELDS_FAILURE(state: State, action: PayloadAction<number>) {
        const catalogue = getCatalogueDataById(state, action.payload)
        catalogue.isFetchingFields = false
    },
}
...
export const fetchFieldsChoicesReducers = {
    FETCH_CURRENT_USER_FIELDS_CHOICES(state: State, action: PayloadAction<T.CatalogueAndFieldIdPayload>) { },
    FETCH_CURRENT_USER_FIELDS_CHOICES_START(state: State, action: PayloadAction<number>) {
        const catalogue = getCatalogueDataById(state, action.payload)
        catalogue.isFetchingFieldsChoices = true
    },
    FETCH_CURRENT_USER_FIELDS_CHOICES_SUCCESS(state: State, action: PayloadAction<T.FetchFieldsChoicesPayload>) {
        const catalogue = getCatalogueDataById(state, action.payload.catalogueId)
    ...
    FETCH_CURRENT_USER_FIELDS_CHOICES_FAILURE(state: State, action: PayloadAction<number>) {
        const catalogue = getCatalogueDataById(state, action.payload)
        catalogue.isFetchingFieldsChoices = false
    },
}