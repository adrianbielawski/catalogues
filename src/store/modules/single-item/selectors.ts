import {
    AuthUserChoiceData, AuthUserChoiceFieldData, AuthUserFieldData, DeserializedCommentData
...
export const getChoiceDataById = (
    ...
    (getFieldDataById(state, fieldId) as AuthUserChoiceFieldData).choices.filter(c => c.id === choiceId)[0]
)
