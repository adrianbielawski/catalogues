...
export const singleItems = {
  ...
  FETCH_MORE_SINGLE_ITEM_COMMENTS(
    state: State,
    action: PayloadAction<T.FetchMoreSingleItemCommentsPayload>,
  ) {},
}
...
export const fetchSingleItemComments = {
  FETCH_SINGLE_ITEM_COMMENTS(
    state: State,
    action: PayloadAction<T.FetchSingleItemCommentsPayload>,
  ) {},
  FETCH_SINGLE_ITEM_COMMENTS_START(
    state: State,
    action: PayloadAction<number>,
  ) {
    state.itemData!.isFetchingComments = true
  },
  FETCH_SINGLE_ITEM_COMMENTS_SUCCESS(
    state: State,
    action: PayloadAction<ListData<ItemCommentParent>>,
  ) {
...
export const fetchSingleItemCatalogues = {
  ...
  FETCH_SINGLE_ITEM_CATALOGUE_SUCCESS(
    state: State,
    action: PayloadAction<number>,
  ) {
...
export const fetchSingleItemChoices = {
  ...
  FETCH_SINGLE_ITEM_CHOICES_SUCCESS(
    state: State,
    action: PayloadAction<Record<number, Choice[]>>,
  ) {
...
export const postSingleItemComment = {
  POST_SINGLE_ITEM_COMMENT(
    state: State,
    action: PayloadAction<T.PostSingleItemCommentPayload>,
  ) {},
  POST_SINGLE_ITEM_COMMENT_START(state: State, action: PayloadAction<number>) {
    state.itemData!.isPostingComment = true
  },
  POST_SINGLE_ITEM_COMMENT_SUCCESS(
    state: State,
    action: PayloadAction<T.PostSingleItemCommentSuccessPayload>,
  ) {
  ...
  POST_SINGLE_ITEM_COMMENT_FAILURE(
    state: State,
    action: PayloadAction<number>,
  ) {
    state.itemData!.isPostingComment = false
