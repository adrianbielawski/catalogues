...
export const {
  ...
  CLEAR_ITEM_ERROR,
  FETCH_CURRENT_USER_ITEM,
  FETCH_CURRENT_USER_ITEM_START,
  FETCH_CURRENT_USER_ITEM_SUCCESS,
  FETCH_CURRENT_USER_ITEM_FAILURE,
  ...
  CHANGE_FAVOURITE_ITEM_SUCCESS,
  CHANGE_FAVOURITE_ITEM_FAILURE,
  FETCH_ITEM_COMMENTS,
  FETCH_ITEM_COMMENTS_START,
  FETCH_ITEM_COMMENTS_SUCCESS,
  FETCH_ITEM_COMMENTS_FAILURE,
  FETCH_ITEMS_COMMENTS,
  FETCH_ITEMS_COMMENTS_START,
  FETCH_ITEMS_COMMENTS_SUCCESS,
  FETCH_ITEMS_COMMENTS_FAILURE,
  POST_ITEM_COMMENT,
  POST_ITEM_COMMENT_START,
