...
export const fetchLatestCataloguesEpic = (action$: Observable<Action>) =>
  action$.pipe(
...
export const latestCataloguesEpics = combineEpics(fetchLatestCataloguesEpic)
