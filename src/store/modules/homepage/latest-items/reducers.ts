...
export const fetchLatestItemsComments = {
    ...
    FETCH_LATEST_ITEMS_COMMENTS_SUCCESS(state: State, action: PayloadAction<T.FetchLatestItemsCommentsSuccessPayload>) {
...
export const fetchLatestItemsCatalogues = {
    ...
    FETCH_LATEST_ITEMS_CATALOGUES_SUCCESS(state: State, action: PayloadAction<number[]>) { },
...
export const fetchLatestItemsFields = {
    ...
    FETCH_LATEST_ITEMS_FIELDS_SUCCESS(state: State, action: PayloadAction<Field[]>) { },
...
export const fetchLatestItemsChoices = {
    ...
    FETCH_LATEST_ITEMS_CHOICES_SUCCESS(state: State, action: PayloadAction<Field[]>) {
        state.isFetchingData = false
    },
...
export const fetchLatestItemComments = {
    FETCH_LATEST_ITEM_COMMENTS(state: State, action: PayloadAction<T.FetchLatestItemCommentsPayload>) { },
    FETCH_LATEST_ITEM_COMMENTS_START(state: State, action: PayloadAction<number>) {
        const itemData = getItemDataById(state, action.payload)
        itemData.isFetchingComments = true
    },
    FETCH_LATEST_ITEM_COMMENTS_SUCCESS(state: State, action: PayloadAction<T.FetchLatestItemCommentsSuccessPayload>) {
    ...
    FETCH_LATEST_ITEM_COMMENTS_FAILURE(state: State, action: PayloadAction<number>) {
        const itemData = getItemDataById(state, action.payload)
        itemData.isFetchingComments = false
    },
}
...
export const postLatestItemComment = {
    POST_LATEST_ITEM_COMMENT(state: State, action: PayloadAction<T.PostLatestItemCommentPayload>) { },
    POST_LATEST_ITEM_COMMENT_START(state: State, action: PayloadAction<number>) {
        const itemData = getItemDataById(state, action.payload)
        itemData.isPostingComment = true
    },
    POST_LATEST_ITEM_COMMENT_SUCCESS(state: State, action: PayloadAction<T.PostLatestItemCommentSuccessPayload>) {
    ...
    POST_LATEST_ITEM_COMMENT_FAILURE(state: State, action: PayloadAction<number>) {
        const itemData = getItemDataById(state, action.payload)
        itemData.isPostingComment = false
