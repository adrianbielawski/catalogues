...
export const {
    ...
    FETCH_LATEST_ITEMS_FIELDS, FETCH_LATEST_ITEMS_FIELDS_SUCCESS, FETCH_LATEST_ITEMS_FIELDS_FAILURE, LATEST_ITEMS_FIELDS_NOT_NEEDED,
    FETCH_LATEST_ITEMS_CHOICES, FETCH_LATEST_ITEMS_CHOICES_SUCCESS, FETCH_LATEST_ITEMS_CHOICES_FAILURE,
    FETCH_LATEST_ITEM_COMMENTS, FETCH_LATEST_ITEM_COMMENTS_START, FETCH_LATEST_ITEM_COMMENTS_SUCCESS, FETCH_LATEST_ITEM_COMMENTS_FAILURE,
    POST_LATEST_ITEM_COMMENT, POST_LATEST_ITEM_COMMENT_START, POST_LATEST_ITEM_COMMENT_SUCCESS, POST_LATEST_ITEM_COMMENT_FAILURE,
