...
export const {
  ...
  CREATE_CATALOGUE,
  CREATE_CATALOGUE_START,
  CREATE_CATALOGUE_SUCCESS,
  CREATE_CATALOGUE_FAILURE,
  NEW_CATALOGUE_CREATED,
  FETCH_AUTH_USER_CATALOGUES,
  FETCH_AUTH_USER_CATALOGUES_START,
  FETCH_AUTH_USER_CATALOGUES_SUCCESS,
  FETCH_AUTH_USER_CATALOGUES_FAILURE,
  REFRESH_CATALOGUE,
  REFRESH_CATALOGUE_FAILURE,
  TOGGLE_CATALOGUE_NAME_EDIT,
  CHANGE_CATALOGUE_NAME,
  CHANGE_CATALOGUE_NAME_START,
  CHANGE_CATALOGUE_NAME_SUCCESS,
  CHANGE_CATALOGUE_NAME_FAILURE,
  CHANGE_DEFAULT_CATALOGUE,
  CHANGE_DEFAULT_CATALOGUE_SUCCESS,
  CHANGE_DEFAULT_CATALOGUE_FAILURE,
  CHANGE_PUBLIC_CATALOGUE,
  CHANGE_PUBLIC_CATALOGUE_SUCCESS,
  CHANGE_PUBLIC_CATALOGUE_FAILURE,
  POST_CATALOGUE_IMAGE,
  POST_CATALOGUE_IMAGE_START,
  POST_CATALOGUE_IMAGE_SUCCESS,
  POST_CATALOGUE_IMAGE_FAILURE,
  DELETE_CATALOGUE,
  DELETE_CATALOGUE_START,
  ...
  AUTH_USER_CATALOGUES_FIELDS_NOT_NEEDED,
  FETCH_AUTH_USER_CATALOGUES_FIELDS_FAILURE,
  CREATE_CATALOGUE_FIELD,
  CREATE_CATALOGUE_FIELD_START,
  CREATE_CATALOGUE_FIELD_SUCCESS,
  CREATE_CATALOGUE_FIELD_FAILURE,
  ...
  FETCH_FIELDS_CHOICES_START,
  FETCH_FIELDS_CHOICES_SUCCESS,
  FETCH_FIELDS_CHOICES_FAILURE,
  FETCH_AUTH_USER_CATALOGUES_CHOICES_SUCCESS,
  AUTH_USER_CATALOGUES_CHOICES_NOT_NEEDED,
  FETCH_AUTH_USER_CATALOGUES_CHOICES_FAILURE,
  POST_FIELD_CHOICE,
