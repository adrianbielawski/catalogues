...
export const fetchAuthUserCataloguesReducers = {
  ...
  FETCH_AUTH_USER_CATALOGUES_SUCCESS(
    state: State,
...
export const changeCatalogueNameReducers = {
  CHANGE_CATALOGUE_NAME(
    state: State,
    action: PayloadAction<T.ChangeCatalogueNamePayload>,
  ) {},
...
export const changeDefaultCatalogueReducers = {
  CHANGE_DEFAULT_CATALOGUE(
    state: State,
    action: PayloadAction<T.ChangeDefaultCataloguePayload>,
  ) {
  ...
  CHANGE_DEFAULT_CATALOGUE_FAILURE(
    state: State,
...
export const changePublicCatalogueReducers = {
  CHANGE_PUBLIC_CATALOGUE(
    state: State,
    action: PayloadAction<T.ChangePublicCataloguePayload>,
  ) {},
...
export const changeCatalogueImageReducers = {
  POST_CATALOGUE_IMAGE(
    state: State,
    action: PayloadAction<T.ChangeCatalogueImagePayload>,
  ) {},
...
export const deleteCatalogueReducers = {
  ...
  DELETE_CATALOGUE_SUCCESS(state: State, action: PayloadAction<number>) {
    const catalogueIndex = state.cataloguesData.findIndex(
...
export const addCatalogueToFavouriteReducers = {
  ...
  ADD_CATALOGUE_TO_FAVOURITE_FAILURE(
    state: State,
    action: PayloadAction<number>,
  ) {
    const catalogue = getCatalogueDataById(state, action.payload)
...
export const deleteCatalogueFromFavouriteReducers = {
  ...
  DELETE_CATALOGUE_FROM_FAVOURITE_FAILURE(
    state: State,
    action: PayloadAction<number>,
  ) {
    const catalogue = getCatalogueDataById(state, action.payload)
