...
export const {
    ...
    FETCH_FAVOURITE_ITEMS_DATA, FETCH_FAVOURITE_ITEMS_DATA_SUCCESS, FETCH_FAVOURITE_ITEMS_DATA_FAILURE,
    ...
    FETCH_FAVOURITE_ITEM_COMMENTS, FETCH_FAVOURITE_ITEM_COMMENTS_START, FETCH_FAVOURITE_ITEM_COMMENTS_SUCCESS, FETCH_FAVOURITE_ITEM_COMMENTS_FAILURE, FAVOURITE_ITEMS_COMMENTS_NOT_NEEDED,
