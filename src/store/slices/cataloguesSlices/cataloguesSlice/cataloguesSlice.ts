...
import * as catalogues from './reducers/cataloguesReducer'
import * as fields from './reducers/fieldsReducer'
...
export const cataloguesSlice = createSlice({
    ...
    initialState,
    reducers: {
        ...catalogues.createCatalogueReducers,
        ...catalogues.fetchCataloguesReducers,
        ...catalogues.changeCatalogueNameReducers,
        ...fields.fetchCatalogueFieldReducers,
        ...fields.fetchCatalogueFieldsReducers,
        ...fields.fetchFieldsChoicesReducers,
        ...fields.editFieldReducers,
        ...fields.createCatalogueFieldReducers,
    },
