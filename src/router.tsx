import { ReactNode, useEffect, ComponentType, createContext } from 'react'
...
type PrivateRouteProps =
  | PrivateRoutePropsWithComponent
  | PrivateRoutePropsWithRender
  ...
  return (
    <Route
      ...
      render={(props) => {
        ...
        if (canonical) {
          component = (
            <CanonicalUrlWrapper match={match}>{component}</CanonicalUrlWrapper>
          )
        }
...
export const PrivateRoute = (props: PrivateRouteProps) => {
  ...
  const isInitialized = useTypedSelector(
    (state) => state.modules.authUser.isInitialized,
  )
